...
import ru.geracimov.otus.spring.hw15libraryreact.exception.NotFoundException;
import ru.geracimov.otus.spring.hw15libraryreact.repository.BookRepository;
...
import ru.geracimov.otus.spring.hw15libraryreact.services.ReviewService;
...
public class BookServiceImpl implements BookService {
    ...
    public void delReviewFromBook(UUID reviewUuid,
        ...
        Book book = this.bookRepository.findById(bookUuid)
                                       .orElseThrow(NotFoundException::new);
